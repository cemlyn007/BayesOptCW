...
class BayesianOptimisation:
    ...
    def _initialise_gaussian_process(self,
        ...
        self._gaussian_process.initialise_dataset(dataset,
                                                  objective_function_values)

    def run(self,
            number_steps: int,
            initial_dataset: np.ndarray,
            initial_objective_function_values: np.ndarray,
            ) -> Generator:
        """
    ...
    def _step(self,
        ...
        """
        y = self._objective_function.evaluate(
    ...
    def get_best_data_point_index(self) -> np.ndarray:
    ...
    def compute_arg_max_of_acquisition_function(self) -> np.ndarray:
